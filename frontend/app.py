...
<style>
    ...
    /* Keep text styling scoped to content, not every div/span */
    ...
    .summary-card {
        background: linear-gradient(135deg, #172554 0%, var(--bg-card) 100%) !important;
    ...
    div[data-baseweb="input"] textarea {
        ...
        caret-color: var(--control-text) !important;
    }
